...
קובצי המשחק הפעילים הם `index.html`,‏ `styles.css` ו־`script.js`. שמותיהם נשארים קבועים, והעמוד מוסיף להם מזהה טעינה אוטומטי כדי למנוע מהדפדפן להשתמש בגרסה ישנה מהמטמון.
